...
# What percentage of the people who work the minimum number of hours per week have a salary of >50K?
    ...
    rich_country = df.groupby("native-country")["salary"].value_counts(normalize=True).unstack()
    highest_earning_country = rich_country[">50K"].idxmax()
    highest_earning_country_percentage = round(
        rich_country[">50K"].max() * 100, 1
    )
